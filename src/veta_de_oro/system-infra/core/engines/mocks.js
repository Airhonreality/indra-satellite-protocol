...
const MOCK_CATALOGO = [
  ...
  { 
    sku: 'ENS-LAV-001', 
    descripcion: 'Mueble Lavandería Premium Completo',
    precio_unitario: 0, 
    unidad: 'und', 
    categoria: 'Ensambles', 
    tipo: 'ensamble',
    activo: true,
    composicion_json: [
      { sku: 'CAR-LAV-01',     cantidad: 1, tipo_metrica: 'unidad', descripcion_override: 'Estructura carcasa' },
      { sku: 'ACC-HER-CIE-01', cantidad: 4, tipo_metrica: 'unidad', descripcion_override: 'Bisagras puertas'  },
      { sku: 'SUP-LAM-01',     cantidad: 0.36, tipo_metrica: 'porcentaje', descripcion_override: 'Mesón laminado 0.6x0.6m' },
      { sku: 'MO-INS-01',      cantidad: 1, tipo_metrica: 'unidad', descripcion_override: 'Instalación'       },
    ]
  },
  { 
    sku: 'ENS-COC-001', 
    descripcion: 'Cocina Integral Estándar (4 módulos)',
    precio_unitario: 0,
    unidad: 'und', 
    categoria: 'Ensambles', 
    tipo: 'ensamble',
    activo: true,
    composicion_json: [
      { sku: 'CAR-MOD-INF-01', cantidad: 2, tipo_metrica: 'unidad' },
      { sku: 'CAR-MOD-SUP-01', cantidad: 2, tipo_metrica: 'unidad' },
      { sku: 'SUP-QTZ-01',     cantidad: 1.44, tipo_metrica: 'unidad', descripcion_override: '2.4m x 0.6m mesón' },
      { sku: 'ACC-SOC-ALU-01', cantidad: 2.4, tipo_metrica: 'unidad', descripcion_override: 'Zócalo 2.4m corridos' },
      { sku: 'ACC-HER-CIE-01', cantidad: 8, tipo_metrica: 'unidad' },
      { sku: 'MO-INS-01',      cantidad: 4, tipo_metrica: 'unidad' },
      { sku: 'MO-LEV-01',      cantidad: 1, tipo_metrica: 'unidad' },
    ]
  }
];
...
// ═══════════════════════════════════════════
const ESTADO_INICIAL_PROPUESTA = {
  metadatos: {
...
const buscarCliente = (id) => MOCK_CLIENTES.find(c => c.id === id) ?? null;

/** Obtener productos activos por categoría */
const productsPorCategoria = () =>
...
const buscarProducto = (sku) => MOCK_CATALOGO.find(p => p.sku === sku) ?? null;
