...
class IndraUniversalPicker extends HTMLElement {
    ...
    render() {
        ...
        <div class="picker-box">
            ...
            <div class="provider-tags" id="tags-container"></div>
            <input type="text" class="search-input" id="search-input" placeholder="Buscar silo en el universo...">
        </div>
        `;

        this.renderTags(this._providers);

        // Vanilla Input Listener for Filtering
